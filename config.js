...
const APP_CONFIG = {
    ...
    JSONBIN_MODE: false,  // Set to true when you have a valid JSONBin API key
    JSONBIN_API_KEY: 'YOUR_JSONBIN_API_KEY_HERE',  // Replace with your JSONBin.io X-Master-Key
